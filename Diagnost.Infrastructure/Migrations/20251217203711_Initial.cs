        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PZMRLatet = table.Column<double>(type: "double precision", nullable: false),
                    PZMRvidhil = table.Column<double>(type: "double precision", nullable: false),
                    PZMR_ErrorsTotal = table.Column<int>(type: "integer", nullable: false),
                    PV2_3Latet = table.Column<double>(type: "double precision", nullable: false),
                    PV2_StdDev_ms = table.Column<double>(type: "double precision", nullable: false),
                    PV2_ErrorsTotal = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    UFPLatet = table.Column<double>(type: "double precision", nullable: false),
                    UFP_StdDev_ms = table.Column<double>(type: "double precision", nullable: false),
                    UFP_ErrorsTotal = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
